...
2. Делает колонку product_specs.weight nullable: NULL означает
   «вес не задан оператором — использовать WEIGHT_DEFAULTS».
   Все строки с weight=1.0 обнуляются, так как 1.0 был server_default
   миграции 0001, а не явно заданным значением.
